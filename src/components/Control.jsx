...
const Control = () => {
  return (
    <div className="grid xl:grid-cols-3 grid-cols-1  justify-items-center xl:mx-20 gap-4 py-8  dark:bg-gray-900 ">
      <div className="lg:w-[350px] max-w-[384px] max-h-[254px] text-white space-y-2">
        <img src={vector} alt="" />
        <p className="font-[600px] text-[28px] font-Montserrat">
          You’re in Control
        </p>
        <p className="font-[300px] text-[22px] font-Work Sans">
